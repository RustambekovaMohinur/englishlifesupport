  ...
  return (
    <div className="flex h-screen max-h-screen w-full max-w-full overflow-hidden overflow-x-hidden bg-[#FBFBFA] dark:bg-[#0B0F19] font-sans antialiased text-zinc-900 dark:text-zinc-100 transition-colors">
          ...
          {!isCollapsed ? (
            <div className="flex items-center gap-3 min-w-0">
              ...
              <div className="min-w-0">
                ...
                <p className="text-[11px] text-zinc-500 dark:text-zinc-400 truncate">Examiner Desk</p>
              </div>
            </div>
          ) : (
      ...
      <div className="flex min-w-0 flex-1 flex-col h-full overflow-hidden">
        ...
        {/* Content Container: Right-aligned ultra-slim stealth scrollbar */}
        <main className="flex-1 overflow-y-auto overflow-x-hidden scroll-container-right p-3 sm:p-6 lg:p-8 pb-28 sm:pb-24 lg:pb-8">
